...
<b>Return Page</b><br/>
<span style="color:#ff0000"><?php= $_GET['msg']=!isset($_GET['msg'])?"":$_GET['msg'] ; ?></span><br /><br />
Fill out the simple form below to effect the return of an ordered book for a valid user of the Library.<br /><br />
